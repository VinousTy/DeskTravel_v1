...
const PrivacyPolicy: React.FC = () => {
  return (
    <div className="md:w-10/12 mt-10 mb-10 pb-6 md:w-8/12 mx-auto md:h-auto text-white rounded bg-bg-gray">
      <div className="px-10">
        <h2 className="font-bold text-2xl text-center py-10">
          プライバシーポリシー
        </h2>
        <p>
          DeskTravel（以下，「当方」といいます。）は，本ウェブサイト上で提供するサービス（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
        </p>
        ...
        <div>
          Eメールアドレス：
          <Link
            className="text-blue-500 underline decoration-blue-500 hover:text-blue-400 transition-all"
            to="/contact"
          >
            desktravel.customer@gmail.com
          </Link>
        </div>
      </div>
    </div>
